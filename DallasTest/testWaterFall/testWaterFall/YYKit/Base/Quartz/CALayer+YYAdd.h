 ...
 *
 *  @param rect         背景大小
 *  @param cornerRadius 倒角
 *  @param colors       颜色  ex:@[[UIColor redColor],[UIColor blueColor]]
 *  @param points       点s   ex:@[[NSValue valueWithCGPoint:CGPointMake(0,0)],[NSValue valueWithCGPoint:CGPointMake(1.0,1.0)]]
 *
 ...
 *  @param size         背景大小
 *  @param colors       颜色  ex:@[[UIColor redColor],[UIColor blueColor]]
 *  @param locations    位置  ex: @[@(0),@(1)]
 *  @param points       点s  ex:@[[NSValue valueWithCGPoint:CGPointMake(0,0)],[NSValue valueWithCGPoint:CGPointMake(1.0,1.0)]]->里面实际要换算成坐标,这个是比例
 *
